    ...
    public class ItemRepository : IRepository<Item, Guid>
    {
        public void Create(Item entity)
        {
            ...
            var parameters = new[]
            {
                ...
                new SqlParameter("@Unit", entity.Unit.TryGetValue("Name", out var unitName) ? unitName : DBNull.Value),
                new SqlParameter("@IntegerUnit", entity.IsUnitInteger()),
        ...
        {
            string command = "UPDATE ITEMS SET Name = @Name, Unit = @Unit, IntegerUnit = @IntegerUnit, ItemsCategoryId = @ItemsCategoryId, CurrentStock = @CurrentStock WHERE Id = @Id";
            var parameters = new[]
            {
        ...
        {
            string command = @"
                SELECT i.Id, i.Name, i.Unit, i.IntegerUnit, i.CurrentStock, 
