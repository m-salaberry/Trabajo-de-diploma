...
namespace Services.DAL.Implementations.Repositories
{
    ...
    public class UsersRepository : IRepository<User>
    {
        ...
        public void Delete(User entity)
        {
            ...
            FillUserFamily(entity);
            foreach (var family in entity.Permissions.OfType<Family>())
            {
                DeleteRelationBetweenUserAndFamily(entity, family);
            }
        ...
        /// <returns>The user that matches the specified ID, or null if not found.</returns>
        ...
        /// Includes user's families (roles) and their associated patents.
        /// </summary>
        /// <returns>A list of all active users with their permissions loaded.</returns>
